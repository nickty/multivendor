				...
				<div class="col l2 s6 m4">
					<div class="card"  style="height: 280px;">
						...
						<span class="divpr" id="divpr<?= $product['id']; ?>">
							<button class="btn cart" id="pr<?= $product['id']; ?>" style="width: 100%;">Add to Cart</button>
						</span>
						<button href="<?= base_url().'home/single_product/'.$product['id']; ?>" class="btn orange" style="width: 100%;">View More</button>
			...
			<?php foreach($men_fashon as $product) : ?>
				...
				<div class="col l2 s6 m4">
					<div class="card"  style="height: 280px;">
						...
						<div class="card-content">
							<span class="card-title" id="namepr<?= $product['id']; ?>"><?= substr($product['title'], 0, 10);  ?></span>
